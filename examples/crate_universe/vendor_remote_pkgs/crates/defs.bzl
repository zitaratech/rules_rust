...
_NORMAL_DEPENDENCIES = {
    "": {
        _COMMON_CONDITION: {
            ...
            "serde_json": "@crates_vendor_pkgs__serde_json-1.0.91//:serde_json",
...
def crate_repositories():
    ...
    maybe(
        http_archive,
        name = "crates_vendor_pkgs__async-trait-0.1.60",
        sha256 = "677d1d8ab452a3936018a687b20e6f7cf5363d713b732b8884001317b0e48aa3",
        type = "tar.gz",
        urls = ["https://crates.io/api/v1/crates/async-trait/0.1.60/download"],
        strip_prefix = "async-trait-0.1.60",
        build_file = Label("@examples//vendor_remote_pkgs/crates:BUILD.async-trait-0.1.60.bazel"),
    )
    ...
    maybe(
        http_archive,
        name = "crates_vendor_pkgs__proc-macro2-1.0.49",
        ...
        build_file = Label("@examples//vendor_remote_pkgs/crates:BUILD.proc-macro2-1.0.49.bazel"),
    )
    ...
    maybe(
        http_archive,
        name = "crates_vendor_pkgs__serde_json-1.0.91",
        ...
        build_file = Label("@examples//vendor_remote_pkgs/crates:BUILD.serde_json-1.0.91.bazel"),
    )
